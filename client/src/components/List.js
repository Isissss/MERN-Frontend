    ...
    return <div>
        <div className="list" >
            <div className="list-header">
                <span onClick={(e) => setEditing(true)}>  {editing ? <form onSubmit={(e) => updateList(e)} > <input type="text" ref={inputRef} value={title} onBlur={(e) => updateList(e)} onChange={(e) => formHandler(e)} />  </form> : (title)} </span>
